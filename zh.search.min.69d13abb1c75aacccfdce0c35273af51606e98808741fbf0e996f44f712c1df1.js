...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.3631d24eceb8afbb6eddceade3f26d23922cc78da462d111298b553065275ace.js',function(){input.required=false;search();});}
